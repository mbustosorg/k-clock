...
export var time_interval = 5
var bev_poof_triggered = false
var bev_poof_start = 0
export var bev_poof_t = 1
var time_arg = 0.01
var divisor = 3
prngSeed(0)
...
export function coronalBeforeRender(delta) {
  translate(-0.5,-0.5)
...
export function coronalRender2D(index, x, y) {
...
var beforeRenderBackground = (delta) => coronalBeforeRender(delta)
var renderBackground = (index, x, y) => coronalRender2D(index, x, y)
