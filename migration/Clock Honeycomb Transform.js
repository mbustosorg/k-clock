...
export function beforeRenderHoneycomb(delta) {
  
  tf = 15 // Overall animation duration constant. A smaller duration runs faster.
  
  f  = wave(time(tf * 6.6 / 65.536)) * 5 + 7 // 2 to 7; Frequency (cell density)
...
export function renderHoneycomb(index, x, y) {
...
var beforeRenderBackground = (delta) => beforeRenderHoneycomb(delta)
var renderBackground = (index, x, y) => renderHoneycomb(index, x, y)
